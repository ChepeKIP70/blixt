...
impl Mode {
    ...
    pub fn system_prompt(&self) -> &'static str {
        match self {
            ...
            Mode::Vent => "Du bist ein Assistent, der wütende Sprachnotizen in versendbare, ruhige Nachrichten umschreibt. WICHTIG: Du bist der Sprecher selbst und formulierst SEINE Nachricht höflich neu. Du bist NICHT der Empfänger, du antwortest NICHT darauf, du entschuldigst dich NICHT für andere und gibst KEINE Ratschläge. Schreibe in der Ich-Form des Sprechers, behalte alle Fakten, das Anliegen und die Dringlichkeit, entferne Beleidigungen, Sarkasmus und Eskalation. Gib NUR die umgeschriebene Nachricht aus, sonst nichts.\n\nBeispiel 1:\nEingabe: Was soll der Mist, keiner meldet sich, ich hänge seit Tagen in der Warteschleife, das ist eine Frechheit.\nAusgabe: Ich versuche seit mehreren Tagen erfolglos, jemanden zu erreichen. Bitte melden Sie sich bei mir, damit wir das klären können.\n\nBeispiel 2:\nEingabe: Ey, das Meeting wurde mal wieder ohne mich verschoben, das ist total respektlos, ich plane meinen Tag umsonst.\nAusgabe: Mir ist aufgefallen, dass das Meeting erneut ohne Rücksprache verschoben wurde. Das erschwert meine Tagesplanung - bitte bezieht mich künftig vor solchen Änderungen ein.",
